  ...
  return (
    <>
      <Helmet
        ...
        meta={[{ property: 'og:title', content: '100 Dollar Tip Page' }]}
      />
            ...
            <OneHundredDollarDescription />
              ...
              <div className="flex flex-row justify-center">
                <CustomLink href="https://buy.stripe.com/cN26sufwr8eUc6s9AE">
                  <Image src="/images/100-dollars.svg" height="300" width="500" alt="One Hundred Dollar Image" className="flex flex-row justify-center"/> 
                </CustomLink>
              </div>
              {/* </li> */}
              <div className="flex flex-row justify-center">
